...
from application.investments.queries.get_investment_yields import GetInvestmentYieldsHandler
from application.investments.queries.get_investment_projections import GetInvestmentProjectionsHandler
...
from infrastructure.database.repositories.sqlalchemy_investment_yield_repository import SQLAlchemyInvestmentYieldRepository
from infrastructure.database.repositories.sqlalchemy_investment_card_repository import SQLAlchemyInvestmentSettingsRepository
...
from presentation.dependencies.repositories import (
    get_account_repository, get_investment_settings_repository
)
...
def get_investment_yields_handler(
    ...
    yield_repo: SQLAlchemyInvestmentYieldRepository = Depends(get_investment_yield_repository),
